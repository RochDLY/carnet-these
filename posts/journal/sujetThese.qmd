...
bibliography: ../../bibliographie/sujet-fev-23.bib
---
...
Cette notion apparaît pour la première fois en l'an 397 dans les écrits de Saint-Augustin [-@augustin_confessions_1993] et s'enrichit depuis d'une multitude d'acceptions [@montemont_dans_2009;@simonet-tenantPourApprocheHistorique2020].
...
Dans l'Allemagne des années 1970, Friedrich Kittler [@merschTheorieMediasIntroduction2018;-@kittler_mode_2015;-@kittler_gramophone_2018] traite, à la suite de McLuhan, de la question de l'écriture et du medium qu'est l'ordinateur (sujet qui n'est pas tant abordé par McLuhan).
...
S'opère alors une transformation des espaces et des architectures à laquelle le modèle de publication scientifique n'échappe pas [@vitali-rosati_quest-ce_2020].
...
L'auteur s'appuit obligatoirement sur des architextes [@souchierPourPoetiqueEcrit1999] pour amorcer l'action d'écriture, seulement cette action n'est pas celle qui enregistre l'information sur son support.
...
Ce principe où toutes les interventions éditoriales dans un texte sont mises en lumière et participent à créer une forme d'auctorialité, Souchier et Jeanneret le nomme « énonciation éditoriale » [@souchier_image_1998;@jeanneretEnonciationEditorialeDans2005].
...
À ce propos, John Maxwell aborde cette particularité sous l'angle de la bienveillance dans son article « The Care-ful Reviewer : Peer Review as if People Mattered » [@maxwellCarefulReviewerPeer2022]. 
